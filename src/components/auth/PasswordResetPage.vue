<template>
  <div class="container">
    <div class="col-xs-8 col-xs-offset-0 col-sm-6 col-sm-offset-3 col-md-6 col-md-offset-3 col-lg-6 col-lg-offset-3">
      ...
      <form @submit.prevent="validateBeforeSubmit" novalidate>
        <div class="form-group">
          ...
          <div class="field">
            <input type="email" id="email" name="email" class="form-control" placeholder="Email" :value="userData.email" readonly />
          </div>
        </div>
...
<script src="./PasswordResetPage.vue.js"></script>
